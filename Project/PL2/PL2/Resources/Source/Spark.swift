...
extension Spark{
    ...
    func animateIgniteHide(_ duration: Double, delay: Double = 0, animationCompleteStatus: Bool = false){
        self.layoutIfNeeded()
        ...
        UIView.animate(
            ...
            animations: {
                ...
                if animationCompleteStatus == true {
                    print("Animation complete")
                    NotificationCenter.default.post(name: NSNotification.Name(rawValue: SCROLL_OBSERVER), object: nil)
                }
        })
    }
}
